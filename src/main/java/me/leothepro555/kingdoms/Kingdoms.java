...
import me.leothepro555.kingdoms.listeners.*;
import org.bukkit.*;
...
public class Kingdoms extends BukkitPlugin implements Listener {
  ...
  public void onEnable() {
                ...
                for (Entity e : getNearbyEntities(turret.getLocation(), 7)) {
                  ...
                  if (e instanceof LivingEntity) {
                    if (e instanceof Player) {
                      if (((Player) e).getGameMode() == GameMode.SURVIVAL || ((Player) e)
                              .getGameMode() == GameMode.ADVENTURE) {
                        if (!turrets.getString(TechnicalMethods.locationToStringTurret(turret.getLocation()))
                                    .equals(getKingdom((Player) e))) {
    ...
    for (String kingdom : kingdoms.getKeys(false)) {
      ...
      if (kingdoms.getString(kingdom + ".nexus-block") != null) {
        ...
        Bukkit.getLogger()
              .severe(ChatColor.RED + "The kingdom in your config file, " + kingdom + " is corrupted. " + "Did you modify the kingdoms.yml file lately? If " + kingdom + " is not supposed to exist, " + "delete it in the kingdoms.yml file.");
      }
      int landnum = 0;
    ...
    for (String s : getConfig().getStringList("resource-point-trade-blacklist")) {
      if (Material.getMaterial(s) != null) {
        ...
        Bukkit.getLogger()
              .severe(ChatColor.RED + "Your Material, " + s + " typed under the trade blacklist is invalid!");
      }
    }
      ...
      if (split.length == 2) {
        if (Material.getMaterial(split[0]) != null) {
          try {
            ...
            Bukkit.getLogger()
                  .severe(ChatColor.RED + "Your Material, " + s + " typed under the trade whitelist is invalid!");
          }
        } else {
          Bukkit.getLogger()
                .severe(ChatColor.RED + "Your Material, " + s + " typed under the trade whitelist is invalid!");
      ...
      if (split.length == 2) {
        if (Material.getMaterial(split[0]) != null) {
          try {
            ...
            Bukkit.getLogger()
                  .severe(ChatColor.RED + "Your Material, " + s + " typed under the trade speciallist is invalid!");
          }
        } else {
          Bukkit.getLogger()
                .severe(ChatColor.RED + "Your Material, " + s + " typed under the trade speciallist is invalid!");
  ...
  public void setupListeners() {
    ...
    new TechnicalMethods().register();
    new TurretManager().register();
  }
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
    if (sender instanceof Player) {
      ...
      if (cmd.getName().equalsIgnoreCase("k") || cmd.getName().equalsIgnoreCase("kingdom") || cmd.getName()
                                                                                                 .equalsIgnoreCase("kingdoms")) {
          ...
          if (args.length <= 0) {
              ...
              if (args.length >= 2) {
                if (args[1].equalsIgnoreCase("toggle")) {
                  ...
                  if (args.length == 3) {
                    ...
                    p.sendMessage(ChatColor.AQUA + "| King: " + Bukkit
                            .getOfflinePlayer((UUID.fromString(kingdoms.getString(kingdom + ".king")))).getName());
                    ...
                    p.sendMessage(ChatColor.AQUA + "|" + " Nexus Location: " + TechnicalMethods
                            .locationToString(this.getNexusLocation(kingdom)));
                    ...
                    p.sendMessage(ChatColor.AQUA + "| " + kping + "[King]" + Bukkit
                            .getOfflinePlayer((UUID.fromString(kingdoms.getString(kingdom + ".king")))).getName() + "");
            ...
            if (args.length == 1) {
              if (hasKingdom(p)) {
                ...
                p.sendMessage(ChatColor.AQUA + "| King: " + Bukkit
                        .getOfflinePlayer((UUID.fromString(kingdoms.getString(getKingdom(p) + ".king")))).getName());
                ...
                if (Bukkit.getOfflinePlayer((UUID.fromString(kingdoms.getString(getKingdom(p) + ".king"))))
                          .isOnline()) {
                ...
                p.sendMessage(ChatColor.AQUA + "| " + kping + "[King]" + Bukkit
                        .getOfflinePlayer((UUID.fromString(kingdoms.getString(getKingdom(p) + ".king"))))
                        .getName() + "");
              ...
              if (kingdoms.getKeys(false).contains(args[1])) {
                ...
                p.sendMessage(ChatColor.AQUA + "| King: " + Bukkit
                        .getOfflinePlayer((UUID.fromString(kingdoms.getString(args[1] + ".king")))).getName());
                ...
                if (!args[1].equalsIgnoreCase(p.getName())) {
                  if (Bukkit.getOfflinePlayer(args[1]) != null) {
                    ...
                    if (this.kingdoms.getKeys(false).contains(kingdom)) {
                      ...
                      if (Bukkit.getOfflinePlayer((UUID.fromString(kingdoms.getString(kingdom + ".king"))))
                                .isOnline()) {
                      ...
                      p.sendMessage(ChatColor.AQUA + "| " + kping + "[King]" + Bukkit
                              .getOfflinePlayer((UUID.fromString(kingdoms.getString(kingdom + ".king"))))
                              .getName() + "");
            ...
            if (args.length == 2) {
              if (Bukkit.getPlayer(args[1]) != null) {
                if (getKingdom(Bukkit.getPlayer(args[1])) == null || !getKingdom(Bukkit.getPlayer(args[1]))
                        .equals(getKingdom(p))) {
                  ...
                  Bukkit.getPlayer(args[1])
                        .sendMessage(ChatColor.GREEN + p.getName() + " has invited you to join " + getKingdom(p));
                  Bukkit.getPlayer(args[1])
                        .sendMessage(ChatColor.GREEN + "Do /k join " + getKingdom(p) + " to accept the invite.");
                  Bukkit.getPlayer(args[1]).sendMessage(ChatColor.GREEN + "");
            ...
            if (args.length == 2) {
              if (Bukkit.getPlayer(args[1]) != null) {
                ...
                Bukkit.getPlayer(args[1])
                      .sendMessage(ChatColor.RED + "Your invitation to " + getKingdom(p) + " has been revoked.");
                  ...
                  if (Bukkit.getOfflinePlayer(args[1]) != null) {
                    if (getKingdom(Bukkit.getOfflinePlayer(args[1])).equals(getKingdom(p))) {
                      if (isMod(getKingdom(p), Bukkit.getOfflinePlayer(args[1])) && !isKing(p)) {
                        ...
                        messageKingdomPlayers(getKingdom(p), ChatColor.GREEN + p
                                .getName() + " kicked " + args[1] + " from your kingdom! :O");
                      }
                    } else {
            ...
            if (isKing(p)) {
              if (getChunkKingdom(p.getLocation().getChunk()) != null && getChunkKingdom(p.getLocation().getChunk())
                      .equals(getKingdom(p))) {
            ...
            if (args.length == 2) {
              ...
              } else if (args[1].equalsIgnoreCase("f") || args[1].equalsIgnoreCase("kingdom") || args[1]
                      .equalsIgnoreCase("k") || args[1].equalsIgnoreCase("faction")) {
                if (hasKingdom(p)) {
            ...
            if (hasKingdom(p)) {
              if (hasHome(getKingdom(p))) {
                if (getChunkKingdom(TechnicalMethods.stringToLocation(kingdoms.getString(getKingdom(p) + ".home"))
                                                    .getChunk()) != null) {
                  if (getChunkKingdom(TechnicalMethods.stringToLocation(kingdoms.getString(getKingdom(p) + ".home"))
                                                      .getChunk()).equals(getKingdom(p))) {
  ...
  public void onChat(PlayerCommandPreprocessEvent event) {
    ...
    if (duelpairs.containsValue(event.getPlayer().getUniqueId())) {
      if (array[0].startsWith("/")) {
        ...
        event.getPlayer()
             .sendMessage(ChatColor.RED + "You cannot use commands while dueling a champion! If you have already killed the champion or vice versa, simply relog to solve the problem.");
      }
    }
  }
    ...
    if (this.placingnexusblock.contains(p.getUniqueId())) {
      if (event.getAction() == Action.RIGHT_CLICK_BLOCK) {
        ...
        try {
          ...
          Bukkit.getLogger()
                .severe(ChatColor.RED + "Your worldguard is not the latest! Players will still be able to place a nexus in regioned areas! To prevent this, use /k admin safezone or /k admin warzone to protect an area from claiming.");
        }
        ...
        if (!blacklist.contains(event.getClickedBlock().getType().toString())) {
          if (!hasNexus(getKingdom(p))) {
            ...
            if (getChunkKingdom(loc.getChunk()) != null) {
              if (getChunkKingdom(loc.getChunk()).equals(getKingdom(p))) {
                Location lastnexus = TechnicalMethods
                        .stringToLocation(kingdoms.getString(getKingdom(p) + ".nexus-block"));
          ...
          p.sendMessage(ChatColor.RED + "You can't replace " + event.getClickedBlock().getType().toString()
                                                                    .toUpperCase() + " with your nexus. Nexus placing cancelled");
  ...
  public void onChunkChange(final PlayerChangeChunkEvent event) {
    ...
    if (getChunkKingdom(event.getToChunk()) != null) {
      if (!getChunkKingdom(event.getToChunk()).equals(getChunkKingdom(event.getFromChunk()))) {
        ...
        } else if (!kingdoms.getKeys(false).contains(getChunkKingdom(event.getToChunk())) && !getChunkKingdom(event
                .getToChunk()).equals("SafeZone") && !getChunkKingdom(event.getToChunk()).equals("WarZone")) {
      ...
      if (getChunkKingdom(event.getClickedBlock().getChunk()) != null) {
        if (event.getPlayer().getItemInHand() != null) {
          if (event.getPlayer().isSneaking()) {
            if (event.getPlayer().getItemInHand().getType() == Material.FLINT_AND_STEEL || event.getPlayer()
                                                                                                .getItemInHand()
                                                                                                .getType() == Material.MONSTER_EGG || event
                    .getPlayer().getItemInHand().getType() == Material.MONSTER_EGGS || event.getPlayer().getItemInHand()
                                                                                            .getType() == Material.EGG || event
        ...
        if (getKingdom(event.getPlayer()) == null) {
          event.setCancelled(true);
          event.getPlayer()
               .sendMessage(ChatColor.RED + "You can't interact in " + getChunkKingdom(event.getClickedBlock()
                                                                                            .getLocation()
                                                                                            .getChunk()) + "'s land!");
          return;
        }
  ...
  public void onBlockPlace(BlockPlaceEvent event) {
    ...
    if (getChunkKingdom(event.getBlock().getChunk()) != null) {
      ...
      } else if (!kingdoms.getKeys(false)
                          .contains(getChunkKingdom(event.getBlock().getChunk())) && !getChunkKingdom(event.getBlock()
                                                                                                           .getChunk())
              .equals("SafeZone") && !getChunkKingdom(event.getBlock().getChunk()).equals("WarZone")) {
        if (getChunkKingdom(event.getBlock().getChunk()) != null) {
          p.sendMessage(ChatColor.AQUA + "Entering unoccupied land");
        }
    ...
    if (land.getString(chunkToString(event.getBlock().getLocation().getChunk())) != null) {
      if (!getChunkKingdom(event.getBlock().getLocation().getChunk()).equals(getKingdom(p))) {
        event.setCancelled(true);
        p.sendMessage(ChatColor.RED + "You cannot place blocks in " + getChunkKingdom(event.getBlock().getLocation()
                                                                                           .getChunk()) + "'s land!");
      }
    }
  }
    ...
    if (land.getString(chunkToString(event.getBlock().getLocation().getChunk())) != null) {
      if (!getChunkKingdom(event.getBlock().getLocation().getChunk()).equals(getKingdom(p))) {
        if (adminmode.contains(p.getUniqueId()))
          return;
        event.setCancelled(true);
        p.sendMessage(ChatColor.RED + "You cannot break blocks in " + getChunkKingdom(event.getBlock().getLocation()
                                                                                           .getChunk()) + "'s land!");
      }
    }
  }
  ...
  public void newKingdom(UUID king, String tag) {
    if (tag.length() <= getConfig().getInt("kingdom-char-tag-limit") || getConfig()
            .getInt("kingdom-char-tag-limit") == 0) {
      ...
      Bukkit.getPlayer(king).sendMessage(ChatColor.RED + "Your kingdom name cannot exceed " + getConfig()
              .getInt("kingdom-char-tag-limit") + " characters!");
    }
  }
  ...
  public void kingPlayer(String kingdom, UUID uuid) {
    ...
    Bukkit.broadcastMessage(ChatColor.GOLD + Bukkit.getPlayer(UUID.fromString(oldking))
                                                   .getName() + " has passed leadership of " + kingdom + " to " + Bukkit
  ...
  public boolean hasKingdom(OfflinePlayer p) {
    if (players.getString(p.getUniqueId().toString() + ".kingdom") != null
            && players.getString(p.getUniqueId().toString() + ".kingdom").equals("")) {
      return false;
    }
  ...
  public boolean isMod(String kingdom, OfflinePlayer p) {
    if (hasKingdom(p) && kingdoms.getStringList(kingdom + ".mods").contains(p.getUniqueId().toString()))
      return true;
    return false;
  }
  ...
  public boolean isAlly(String kingdom, OfflinePlayer p) {
    if (hasKingdom(p) && kingdoms.getStringList(kingdom + ".allies").contains(getKingdom(p)))
      return true;
    return false;
  }

  public boolean isEnemy(String kingdom, OfflinePlayer p) {
    if (hasKingdom(p) && kingdoms.getStringList(kingdom + ".enemies").contains(getKingdom(p)))
      return true;
    return false;
  }
  ...
  public void spawnChampion(final String kingdom, final Location location, final Player p) {
    ...
    Bukkit.getScheduler().scheduleSyncDelayedTask(this, new Runnable() {
      ...
      public void run() {
        ...
        champion.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 999999, kingdoms
                .getInt(kingdom + ".champion.speed")));
        ...
        if (!duelpairs.containsValue(event.getDamager().getUniqueId())) {
          if (kingdoms.getInt(getChampionKingdom(event.getEntity()) + ".champion.duel") > 0) {
            ...
            ((Player) event.getDamager())
                    .sendMessage(ChatColor.RED + "You can't damage the champion unless you're the invader!");
          }
        }
      }
    }
  ...
  public void spawnNexusGuard(String kingdom, Location location, Player p) {
    ...
    champion.getEquipment().setChestplateDropChance(0.0f);
    champion.getEquipment().setItemInHandDropChance(0.0f);
    champion.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 999999, this.kingdoms
            .getInt(kingdom + ".champion.speed")));
  ...
  public void onMobAttack(final EntityDamageByEntityEvent event) {
    ...
    if (champions.containsKey(event.getEntity().getUniqueId())) {
      ...
      int antiknockbackchance = this.kingdoms
              .getInt(getChunkKingdom(champions.get(event.getEntity().getUniqueId())) + ".champion.resist");
  ...
  public void onPlayerLeave(PlayerQuitEvent event) {
    if (duelpairs.containsValue(event.getPlayer().getUniqueId())) {
      for (Entity e : event.getPlayer().getNearbyEntities(30, 30, 30)) {
        ...
        if (e instanceof Player) {
          Player p = (Player) e;
          p.sendMessage(ChatColor.RED + "The invader " + event.getPlayer()
                                                              .getName() + " has left! Invasion cancelled!");
        }
      }
    }
  }
  ...
  public void onSunDamage(EntityDamageEvent event) {
    if (champions.get(event.getEntity().getUniqueId()) != null || nexusguards
            .containsKey(event.getEntity().getUniqueId())) {
      ...
      if (champions.get(event.getEntity().getUniqueId()) != null) {
        if (event.getEntity().getKiller() != null) {
          ...
          if (hasKingdom(p) && !getKingdom(p).equals(getChunkKingdom(champions.get(event.getEntity().getUniqueId())))) {
            ...
            p.sendMessage(ChatColor.GREEN + "You have successfully conquered " + getChunkKingdom(champions
                    .get(event.getEntity().getUniqueId())) + "'s land. ");
            champions.remove(event.getEntity().getUniqueId());
          } else {
            event.getEntity().getLastDamageCause().setDamage(0.0);
          }
        } else {
          forceClaimCurrentPosition(champions.get(event.getEntity().getUniqueId()), Bukkit
                  .getPlayer(duelpairs.get(event.getEntity().getUniqueId())));
          Bukkit.getPlayer(duelpairs.get(event.getEntity().getUniqueId()))
                .sendMessage(ChatColor.GREEN + "Invasion Successful.");
          event.getEntity().getKiller()
               .sendMessage(ChatColor.GREEN + "You have successfully conquered " + getChunkKingdom(champions
                       .get(event.getEntity().getUniqueId())) + "'s land. ");
          champions.remove(event.getEntity().getUniqueId());
          duelpairs.remove(event.getEntity().getUniqueId());
        }
      ...
      if (event.getEntity() instanceof Player) {
        ...
        if (duelpairs.containsValue(p.getUniqueId())) {
          for (Entity e : p.getNearbyEntities(30, 30, 30)) {
            ...
            if (e instanceof Player) {
              Player plr = (Player) e;
              plr.sendMessage(ChatColor.RED + "The invader " + p
                      .getName() + " has lost to the champion! Invasion failed!");
            }
          }
        }
      }
  ...
  public void invadeCurrentPosition(Player p) {
    ...
    if (getAmtLand(getKingdom(p)) > ((getConfig().getInt("land-per-member") * getKingdomMemberCount(getKingdom(p))))) {
      p.sendMessage(ChatColor.RED + "With " + getKingdomMemberCount(getKingdom(p)) + " members, you can only claim up to " + (getConfig()
              .getInt("land-per-member") * getKingdomMemberCount(getKingdom(p))) + " land.");
      return;
    }
    if (getChunkKingdom(c) != null) {
      if (!getChunkKingdom(c).equals(getKingdom(p))) {
          ...
          if (!isKAlly(getKingdom(p), getChunkKingdom(c))) {
            if (rpm.hasAmtRp(getKingdom(p), 10)) {
              if (!isNexusChunk(c)) {
                ...
                this.messageKingdomPlayers(getChunkKingdom(c), ChatColor.RED + p
                        .getName() + " is invading your land! Do /k defend to protect it!");
  ...
  public void forceUnclaimCurrentPosition(Chunk c2, Player p, boolean b) {
    ...
    if (!getChunkKingdom(c).equals("")) {
      ...
      if (getChunkKingdom(c).equals("SafeZone") || getChunkKingdom(c).equals("WarZone") || getChunkKingdom(c)
              .equals("")) {
        land.set(chunkToString(c), null);
        saveClaimedLand();
        return;
        ...
        kingdoms.set(getChunkKingdom(c) + ".land", kingdoms.getInt(getChunkKingdom(c) + ".land") - 1);
        messageKingdomPlayers(getChunkKingdom(c), p
                .getName() + " unclaimed your land. Refudning resource points. 5 might lost.");
        return;
      }
    } else if (b) {
  ...
  public Chunk stringToChunk(String s) {
    ...
    try {
      ...
      Bukkit.getLogger()
            .severe(ChatColor.RED + "One of the land claim areas is invalid! Did you change the claimedchunks config recently?");
    } catch (NumberFormatException e) {
      Bukkit.getLogger()
            .severe(ChatColor.RED + "One of the land claim areas is invalid! Did you change the claimedchunks config recently?");
    }
